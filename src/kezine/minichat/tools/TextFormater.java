...
public class TextFormater extends Formatter
{
	...
	public String format(LogRecord record)
	{
		...
		String message = getDate(record.getMillis()) + "[" + record.getLevel().getName() + "] (" + record.getSourceClassName().substring(lastIndex + 1, record.getSourceClassName().length()) + " - " + record.getSourceMethodName() + "): "
				+ record.getMessage() + "\n";
